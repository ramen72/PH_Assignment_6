...
import { CreateAssetCategoryZodSchema, UpdateAssetCategoryZodSchema } from "./category.validation";

const router = Router();

router.post(
  "/",validateRequest(CreateAssetCategoryZodSchema), AssetCategoryController.createAssetCategory,
);
...
router.patch(
  "/:id",validateRequest(UpdateAssetCategoryZodSchema),
