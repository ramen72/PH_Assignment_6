 ...
 */
const createAssetCategory = catchAsync(
  async (req: Request, res: Response) => {
    const payload = req.body;

    const result = await AssetCategoryService.createAssetCategory(
      payload,
    );
...
const getSingleAssetCategory = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result =
      await AssetCategoryService.getSingleAssetCategory(id as string);
 ...
 */
const updateAssetCategory = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
    const payload = req.body;
 ...
 */
const deleteAssetCategory = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
